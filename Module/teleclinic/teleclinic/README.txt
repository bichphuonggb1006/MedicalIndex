...

{
  ...
  "healthInsuranceDirIdConf": "ID của thư mục dịch vụ dùng làm BHYT(vd: 8)",
  "confirmDirIDFee": 8,
  "confirmDirIDFree": 3,
  "descriptions": {
...
healthInsuranceDirIdConf: Cấu hình id của thư mục dịch vụ dùng làm dịch vụ BHYT (BHYT ko tính tiền), Ko set thì k có chọn BHYT
descriptions : Hiện mô tả theo id của thư mục dịch vụ cấu hình. Dạng id dịch vụ => HTML mô tả
