...
class Cryptor {
    ...
    static protected $key = "LY3CiIfHulsvL1XdD8mXenl52P4PUq2C";
    ...
    public function encrypt($data)
    {
        ...
        return bin2hex($iv) . openssl_encrypt($data, $this->method, self::$key, 0, $iv);
    }
    ...
    public function decrypt($data)
    {
        ...
        if(preg_match("/^(.{" . $iv_strlen . "})(.+)$/", $data, $regs)) {
            ...
            if(ctype_xdigit($iv) && strlen($iv) % 2 == 0) {
                return openssl_decrypt($crypted_string, $this->method, self::$key, 0, hex2bin($iv));
            }
        }
